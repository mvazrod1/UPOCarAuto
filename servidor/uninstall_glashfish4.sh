...
# Elimina el directorio de instalacion, el servicio systemd y las variables de entorno del usuario.
...
if [ -n "$USER_HOME" ] && [ "$ORIGINAL_USER" != "root" ]; then
    ...
    echo "Si configuró variables de entorno manualmente, deberá eliminarlas usted mismo."
fi
